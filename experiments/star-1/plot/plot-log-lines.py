...
#     # Plot each category with a larger marker using plot()
    ...
    plt.plot(iterations, log_probabilities[f'pos-control-1-top-{args.k}'], label=f'pos-control-1-top-{args.k}', 
            marker='^', markersize=0.5*marker_size, color=color_map['pos-control-1'], linestyle=':', alpha=0.4, zorder=z_order/25)
    ...
    plt.plot(iterations, log_probabilities[f'pos-control-2-top-{args.k}'], label=f'pos-control-2-top-{args.k}', 
            marker='^', markersize=0.5*marker_size, color=color_map['pos-control-2'], linestyle='--', alpha=0.4, zorder=z_order/25)
    ...
    plt.plot(iterations, log_probabilities[f'qa-experimental-top-{args.k}'], label=f'qa-experimental-top-{args.k}', 
            marker='o', markersize=0.5*marker_size, color=color_map['qa-experimental'], linestyle=':', alpha=0.4, zorder=z_order/25)
...
# Show the plot
    ...
    plt.savefig(f'{FIGURES_PATH}/{VERSION_2}/{args.split.name}_top-{args.k}_withlines.png')
