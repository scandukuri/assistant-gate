...
def main(args: DictConfig) -> None:
    ...
    # Load conversations
    with open(f'/sailhome/andukuri/research_projects/assistant-gate/experiments/v4/simulate-conversations/simulated-conversations/{args.qa_model.shortname}_{args.split.name}.json', 'r') as f:
    ...
    if args.condition.name == 'qa-experimental':
        with open(f'/sailhome/andukuri/research_projects/assistant-gate/experiments/v4/simulate-conversations/simulated-conversations/{args.qa_model.shortname}_{args.split.name}_top-k-{args.k}.json', 'w') as f:
