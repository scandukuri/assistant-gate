...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f'{PERSONAS_PATH}/{VERSION_AG}'):
        os.makedirs(f'{PERSONAS_PATH}/{VERSION_AG}')
    
    with open(f'{PERSONAS_PATH}/{VERSION_AG}/{args.split.name}.json', 'w') as f:
