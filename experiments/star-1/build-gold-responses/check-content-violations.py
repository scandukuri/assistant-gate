...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{CONTENT_VIOLATIONS_PATH}/{VERSION}"):
        os.makedirs(f"{CONTENT_VIOLATIONS_PATH}/{VERSION}")
    with open(f"{CONTENT_VIOLATIONS_PATH}/{VERSION}/{args.split.name}.json", 'w') as f:
