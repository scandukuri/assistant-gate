...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f'{PERSONAS_PATH}/{VERSION_3_QSFT}'):
        os.makedirs(f'{PERSONAS_PATH}/{VERSION_3_QSFT}')
    
    with open(f'{PERSONAS_PATH}/{VERSION_3_QSFT}/{args.split.name}.json', 'w') as f:
