...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{SPECIFICITY_PATH}/{VERSION_3_MISTRAL_ABLATION}"):
        os.makedirs(f"{SPECIFICITY_PATH}/{VERSION_3_MISTRAL_ABLATION}")
    with open(f"{SPECIFICITY_PATH}/{VERSION_3_MISTRAL_ABLATION}/{args.split.name}_ratings.json", 'w') as f:
