...
#SBATCH --output=script-logs-2-gemma-ablation/get-ratings-counterbalanced.out
#SBATCH --error=script-logs-2-gemma-ablation/get-ratings-counterbalanced.err
...
cd ~/research_projects/assistant-gate/experiments/star-2-gemma-ablation/response-win-rates-counterbalanced/
