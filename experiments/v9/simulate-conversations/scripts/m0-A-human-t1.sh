...
#SBATCH --output=script-logs/m0-A-human-t1.out
#SBATCH --error=script-logs/m0-A-human-t1.err
...
python generate-human.py qa_model=m0 human_model=M0 split=A turn=t1
