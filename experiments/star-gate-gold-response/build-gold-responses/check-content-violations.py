...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_1_ESFT}"):
        os.makedirs(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_1_ESFT}")
    with open(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_1_ESFT}/{args.split.name}.json", 'w') as f:
