...
#SBATCH --output=script-logs-2-bsft/get-ratings-counterbalanced.out
#SBATCH --error=script-logs-2-bsft/get-ratings-counterbalanced.err
...
cd ~/research_projects/assistant-gate/experiments/star-2-bsft/response-win-rates-counterbalanced/
