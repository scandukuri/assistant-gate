...
cd ~/research_projects/assistant-gate/experiments/v6/simulate-conversations-efficient/
...
do
    ...
    python generate-qa.py qa_model=m1 human_model=M0 split=B
    # Call generate-human.py script
    python generate-human.py qa_model=m1 human_model=M0 split=B
done