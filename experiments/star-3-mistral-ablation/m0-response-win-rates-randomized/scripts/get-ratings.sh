...
#SBATCH --output=script-logs-3-mistral-ablation/get-m0-ratings-randomized.out
#SBATCH --error=script-logs-3-mistral-ablation/get-m0-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-3-mistral-ablation/m0-response-win-rates-randomized/
