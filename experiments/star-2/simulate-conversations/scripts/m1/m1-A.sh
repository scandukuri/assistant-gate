...
#SBATCH --output=script-logs-2/m1-A.out
#SBATCH --error=script-logs-2/m1-A.err
...
do
    ...
    python generate-qa.py qa_model=m1 human_model=m0 split=A turn="t$i"
    # Call generate-human.py script
    python generate-human.py qa_model=m1 human_model=m0 split=A turn="t$i"
done
