...
def main(args: DictConfig) -> None:
    logging.info(f"Loading models for multi-turn dialogue for train split {SPLIT}...")
    random.seed(1)
    ...
    with open(f"simulated-conversations/public/split-{SPLIT}_qa-{QA_PROMPT_IDX}_humansys-{HUMAN_SYS_PROMPT_IDX}_human-{HUMAN_PROMPT_IDX}_maxturns-{MAX_TURNS}.json", 'w') as f:
