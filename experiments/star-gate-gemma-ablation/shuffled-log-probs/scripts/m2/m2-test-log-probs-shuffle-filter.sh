...
#SBATCH --output=script-logs-2-gemma-ablation/m2-test-log-probs-shuffled-filter.out
#SBATCH --error=script-logs-2-gemma-ablation/m2-test-log-probs-shuffled-filter.err
