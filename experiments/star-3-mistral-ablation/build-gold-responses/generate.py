...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{GOLD_PATH}/{VERSION_3_MISTRAL_ABLATION}"):
        os.makedirs(f"{GOLD_PATH}/{VERSION_3_MISTRAL_ABLATION}")
    ...
    for j, persona in enumerate(personas):
        ...
        with open(f"{GOLD_PATH}/{VERSION_3_MISTRAL_ABLATION}/{args.split.name}.json", 'w') as f:
