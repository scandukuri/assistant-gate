...
LOGPROBS_DIR = '/sailhome/andukuri/research_projects/assistant-gate/experiments/v2/conditions/qa-experimental/log-probs/logprobs-qa-model-mistral-7b-instruct-v02-vllm_human-model-mistral-7b-instruct-v02-vllm_qa-12_humansys-1_human-4_maxturns-4.json'
k = 1
