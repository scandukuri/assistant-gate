...
#     # Plot each category with a larger marker using plot()
    ...
    with open('star-1-mistral-ablation-qa-experimental_means.json', 'w') as f:
        json.dump(experimental_means, f)
    with open('star-1-mistral-ablation-qa-experimental_sems.json', 'w') as f:
        json.dump(experimental_sems, f)
    with open('star-1-mistral-ablation-qa-experimental_topk_means.json', 'w') as f:
        json.dump(experimental_topk_means, f)
    with open('star-1-mistral-ablation-qa-experimental_topk_sems.json', 'w') as f:
...
# Show the plot
    ...
    plt.savefig(f'{FIGURES_PATH}/{VERSION_1_MISTRAL_ABLATION}/{VERSION_1_MISTRAL_ABLATION}-log_probs_{args.split.name}_top-{args.k}.png')
