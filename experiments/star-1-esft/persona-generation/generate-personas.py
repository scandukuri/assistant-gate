...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f'{PERSONAS_PATH}/{VERSION_1_ESFT}'):
        os.makedirs(f'{PERSONAS_PATH}/{VERSION_1_ESFT}')
    
    with open(f'{PERSONAS_PATH}/{VERSION_1_ESFT}/{args.split.name}.json', 'w') as f:
