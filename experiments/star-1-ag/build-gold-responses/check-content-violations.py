...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_AG}"):
        os.makedirs(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_AG}")
    with open(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_AG}/{args.split.name}.json", 'w') as f:
