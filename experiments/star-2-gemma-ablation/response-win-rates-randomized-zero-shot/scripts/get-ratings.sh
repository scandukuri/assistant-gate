...
#SBATCH --output=script-logs-2-gemma-ablation/get-ratings-randomized.out
#SBATCH --error=script-logs-2-gemma-ablation/get-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-2-gemma-ablation/response-win-rates-randomized-zero-shot/
