...
def main(args: DictConfig) -> None:
    ...
    # Title and labels
    ax.set_title(f'{VERSION_2_BSFT}\nSHUFFLED Log-Probability of Desired Results by Category')
    ...
    plt.savefig(f'{FIGURES_PATH}/{VERSION_2_BSFT}/{VERSION_2_BSFT}-log_probs_general-vs-specific-{args.split.name}-shuffled_top-{args.k}.png')
