...
python get-responses.py qa_model=m0 split=test tokenizer=m0
python get-responses.py qa_model=m1 split=test tokenizer=m0
python get-responses.py qa_model=m2 split=test tokenizer=m0
