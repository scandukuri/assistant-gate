...
#SBATCH --output=script-logs-1-esft/get-m0-ratings-randomized.out
#SBATCH --error=script-logs-1-esft/get-m0-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-1-esft/m0-response-win-rates-randomized/
