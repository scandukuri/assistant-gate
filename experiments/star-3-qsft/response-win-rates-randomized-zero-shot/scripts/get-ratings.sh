...
#SBATCH --output=script-logs-3-qsft/get-ratings-randomized.out
#SBATCH --error=script-logs-3-qsft/get-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-3-qsft/response-win-rates-randomized/
