...
def main(args: DictConfig) -> None:
    ...
    with open(f"{LOGPROBS_PATH}/{LLAMA_VERSION}/{args.condition.name}/{args.qa_model.shortname}/{args.split.name}_top-k-{args.k}_indices.json", 'w') as f:
    ...
    if args.condition.name == 'qa-experimental':
        ...
        with open(f'{SIMULATION_PATH}/{LLAMA_VERSION}/{args.qa_model.shortname}/{args.split.name}_top-k-{args.k}.json', 'w') as f:
