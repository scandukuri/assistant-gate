...
def main(args: DictConfig) -> None:
    ...
    with open('star-2-gemma-ablation-qa-experimental-general_means.json', 'w') as f:
        json.dump(experimental_general_means, f)
    with open('star-2-gemma-ablation-qa-experimental-specific_means.json', 'w') as f:
        json.dump(experimental_specific_means, f)
    with open('star-2-gemma-ablation-qa-experimental-general_topk_means.json', 'w') as f:
        json.dump(experimental_topk_general_means, f)
    with open('star-2-gemma-ablation-qa-experimental-specific_topk_means.json', 'w') as f:
        json.dump(experimental_topk_specific_means, f)
    with open('star-2-gemma-ablation-qa-experimental-general_sems.json', 'w') as f:
        json.dump(experimental_general_sems, f)
    with open('star-2-gemma-ablation-qa-experimental-specific_sems.json', 'w') as f:
        json.dump(experimental_specific_sems, f)
    with open('star-2-gemma-ablation-qa-experimental-general_topk_sems.json', 'w') as f:
        json.dump(experimental_topk_general_sems, f)
    with open('star-2-gemma-ablation-qa-experimental-specific_topk_sems.json', 'w') as f:
    ...
    plt.savefig(f'{FIGURES_PATH}/{VERSION_2_GEMMA_ABLATION}/{VERSION_2_GEMMA_ABLATION}-log_probs_general-vs-specific-{args.split.name}_top-{args.k}.png')
