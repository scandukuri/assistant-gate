...
plt.title(f'Average Log-Probability of Desired Responses [n = {sum([len(lst) for key, lst in pos_control.items()])} simulations]')
...
# Show the plot
plt.savefig(f'figures/plot_all-test_top-{k}.png')
