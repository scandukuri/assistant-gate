...
def main(args: DictConfig) -> None:
    ...
    for t_num, group in enumerate([turns_1, turns_2, turns_3]):
        ...
        with open(f'{WINRATE_PATH}/{VERSION_3_MISTRAL_ABLATION}/{args.qa_model.shortname}_{args.qa_model_2.shortname}/{args.split.name}_turn-{t_num + 1}_win-rates-randomized.json', 'w') as f:
