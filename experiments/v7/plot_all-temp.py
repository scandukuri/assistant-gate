...
plt.errorbar(iterations, [pos_control_mean, ], yerr=[pos_control_sem, ], marker='^', markersize=marker_size, color=color_map['pos-control'], linestyle='', capsize=5, ecolor=error_color, zorder=z_order, fmt='none', label='_nolegend_', elinewidth=1)
plt.errorbar(iterations, [neg_control_mean, ], yerr=[neg_control_sem, ], marker='s', markersize=marker_size, color=color_map['neg-control'], linestyle='', capsize=5,  ecolor=error_color, zorder=z_order, fmt='none', label='_nolegend_', elinewidth=1)
plt.errorbar(iterations, [experimental_mean, ], yerr=[experimental_sem,], marker='o', markersize=marker_size, color=color_map['qa-experimental'], linestyle='',  ecolor=error_color, zorder=z_order, fmt='none', label='_nolegend_', elinewidth=1)

# If the top-k categories also need error bars, adjust similarly
# For example:
plt.errorbar(iterations, [pos_control_topk_mean,], yerr=[pos_control_topk_sem, ], marker='^', markersize=marker_size, color=color_map['pos-control'], linestyle='', capsize=5,  ecolor=error_color, zorder=z_order, fmt='none', label='_nolegend_', elinewidth=1)
plt.errorbar(iterations, [experimental_topk_mean, ], yerr=[experimental_topk_sem, ], marker='o', markersize=marker_size, color=color_map['qa-experimental'], linestyle='', capsize=5,  ecolor=error_color, zorder=z_order, fmt='none', label='_nolegend_', elinewidth=1)
...
plt.title(f'Average Log-Probability of Desired Mixtral Responses [n = {sum([len(lst) for key, lst in pos_control.items()])} simulations]')
...
# Show the plot
plt.savefig(f'figures/plot_all-test-mixtral_top-{k}.png')
