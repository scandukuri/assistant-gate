...
#SBATCH --output=script-logs-1-mistral-ablation/get-responses.out
#SBATCH --error=script-logs-1-mistral-ablation/get-responses.err
...
cd ~/research_projects/assistant-gate/experiments/star-1-mistral-ablation/response-win-rates/
