...
#SBATCH --output=script-logs-3-qsft/get-ratings-counterbalanced.out
#SBATCH --error=script-logs-3-qsft/get-ratings-counterbalanced.err
...
cd ~/research_projects/assistant-gate/experiments/star-3-qsft/response-win-rates-counterbalanced/
