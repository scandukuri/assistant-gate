...
#SBATCH --output=script-logs-llama3/get-ratings-randomized.out
#SBATCH --error=script-logs-llama3/get-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-gate-llama3/response-win-rates-randomized/
