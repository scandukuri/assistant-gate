...
#SBATCH --output=script-logs-3-mistral-ablation/get-ratings-randomized.out
#SBATCH --error=script-logs-3-mistral-ablation/get-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-3-mistral-ablation/response-win-rates-randomized/
