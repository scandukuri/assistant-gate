...
#SBATCH --output=script-logs-2-gemma-ablation/m3-test.out
#SBATCH --error=script-logs-2-gemma-ablation/m3-test.err
...
do
    ...
    python generate-qa.py qa_model=m3 human_model=gemma split=test turn="t$i"
    # Call generate-human.py script
    python generate-human.py qa_model=m3 human_model=gemma split=test turn="t$i"
done
