...
#SBATCH --output=script-logs-1-mistral-ablation/m2-test-log-probs-shuffled-filter.out
#SBATCH --error=script-logs-1-mistral-ablation/m2-test-log-probs-shuffled-filter.err
