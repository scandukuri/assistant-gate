...
#     # Plot each category with a larger marker using plot()
    ...
    with open('star-2-bsft-qa-experimental_means.json', 'w') as f:
        json.dump(experimental_means, f)
    with open('star-2-bsft-qa-experimental_sems.json', 'w') as f:
        json.dump(experimental_sems, f)
    with open('star-2-bsft-qa-experimental_topk_means.json', 'w') as f:
        json.dump(experimental_topk_means, f)
    with open('star-2-bsft-qa-experimental_topk_sems.json', 'w') as f:
...
# Show the plot
    ...
    plt.savefig(f'{FIGURES_PATH}/{VERSION_2_BSFT}/{VERSION_2_BSFT}-log_probs_{args.split.name}_top-{args.k}.png')
