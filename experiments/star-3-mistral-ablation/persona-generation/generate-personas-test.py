...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f'{PERSONAS_PATH}/{VERSION_3_MISTRAL_ABLATION}'):
        os.makedirs(f'{PERSONAS_PATH}/{VERSION_3_MISTRAL_ABLATION}')
    
    with open(f'{PERSONAS_PATH}/{VERSION_3_MISTRAL_ABLATION}/{args.split.name}.json', 'w') as f:
