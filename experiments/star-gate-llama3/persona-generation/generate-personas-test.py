...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f'{PERSONAS_PATH}/{LLAMA_VERSION}'):
        os.makedirs(f'{PERSONAS_PATH}/{LLAMA_VERSION}')
    
    with open(f'{PERSONAS_PATH}/{LLAMA_VERSION}/{args.split.name}.json', 'w') as f:
