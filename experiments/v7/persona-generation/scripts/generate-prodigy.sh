...
#SBATCH --output=generate-prodigy.out
#SBATCH --error=generate-prodigy.err
...
cd /sailhome/andukuri/research_projects/assistant-gate/experiments/v7/persona-generation
