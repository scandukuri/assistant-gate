...
#SBATCH --output=script-logs-llama3/get-ratings-counterbalanced.out
#SBATCH --error=script-logs-llama3/get-ratings-counterbalanced.err
...
cd ~/research_projects/assistant-gate/experiments/star-gate-llama3/response-win-rates-counterbalanced/
