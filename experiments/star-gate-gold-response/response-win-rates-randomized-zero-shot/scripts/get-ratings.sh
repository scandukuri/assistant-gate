...
#SBATCH --output=script-logs-1-esft/get-ratings-randomized.out
#SBATCH --error=script-logs-1-esft/get-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-1-esft/response-win-rates-randomized/
