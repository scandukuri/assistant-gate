...
cd ~/research_projects/assistant-gate/experiments/v7/log-probs/
...
sbatch /sailhome/andukuri/research_projects/assistant-gate/experiments/v7/log-probs/scripts/m0-confusion-filter.sh
