...
def main(args: DictConfig) -> None:
    ...
    plt.title(f'Sequence Lengths for {LLAMA_VERSION} Split {args.qa_model.shortname} Simulated Conversations on {args.split.name} split')
    plt.xlabel('# Tokens')
    ...
    plt.savefig(f'seq-length-plots/{LLAMA_VERSION} {args.qa_model.shortname}-{args.split.name}-sequence-lengths.png')
