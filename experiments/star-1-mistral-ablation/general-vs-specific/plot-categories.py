...
def main(args: DictConfig) -> None:
    ...
    plt.savefig(f'{FIGURES_PATH}/{VERSION_1_MISTRAL_ABLATION}/{VERSION_1_MISTRAL_ABLATION}-log_probs_general-vs-specific-{args.split.name}_top-{args.k}.png')
