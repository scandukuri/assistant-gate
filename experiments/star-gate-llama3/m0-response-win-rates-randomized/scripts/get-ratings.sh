...
#SBATCH --output=script-logs-llama3/get-m0-ratings-randomized.out
#SBATCH --error=script-logs-llama3/get-m0-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-gate-llama3/m0-response-win-rates-randomized/
