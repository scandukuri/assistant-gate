...
#SBATCH --output=script-logs-3-mistral-ablation/get-responses.out
#SBATCH --error=script-logs-3-mistral-ablation/get-responses.err
...
cd ~/research_projects/assistant-gate/experiments/star-3-mistral-ablation/response-win-rates/
