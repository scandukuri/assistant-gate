...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_2}"):
        os.makedirs(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_2}")
    with open(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_2}/{args.split.name}.json", 'w') as f:
