...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{GOLD_PATH}/{VERSION_1_ESFT}"):
        os.makedirs(f"{GOLD_PATH}/{VERSION_1_ESFT}")
    ...
    for j, persona in enumerate(personas):
        ...
        with open(f"{GOLD_PATH}/{VERSION_1_ESFT}/{args.split.name}.json", 'w') as f:
