...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_2_BSFT}"):
        os.makedirs(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_2_BSFT}")
    with open(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_2_BSFT}/{args.split.name}.json", 'w') as f:
