...
#SBATCH --output=script-logs/m0-test-ht3.out
#SBATCH --error=script-logs/m0-test-ht3=.err
...
python generate-human.py qa_model=m0 human_model=M0 split=test turn="t3"
# for ((i=3; i<=n; i++))
# do
