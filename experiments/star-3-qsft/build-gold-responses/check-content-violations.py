...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_3_QSFT}"):
        os.makedirs(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_3_QSFT}")
    with open(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_3_QSFT}/{args.split.name}.json", 'w') as f:
