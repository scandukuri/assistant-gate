...
def main(args: DictConfig) -> None:
    ...
    with open(f"{SPECIFICITY_PATH}/{VERSION_3_QSFT}/{args.split.name}_ratings.json", "r") as f:
        ratings = json.load(f)
    ...
    with open('star-3-qsft-qa-experimental-GPT4-RATED-general_means.json', 'w') as f:
        json.dump(experimental_general_means, f)
    with open('star-3-qsft-qa-experimental-GPT4-RATED-specific_means.json', 'w') as f:
        json.dump(experimental_specific_means, f)
    with open('star-3-qsft-qa-experimental-GPT4-RATED-general_topk_means.json', 'w') as f:
        json.dump(experimental_topk_general_means, f)
    with open('star-3-qsft-qa-experimental-GPT4-RATED-specific_topk_means.json', 'w') as f:
        json.dump(experimental_topk_specific_means, f)
    with open('star-3-qsft-qa-experimental-GPT4-RATED-general_sems.json', 'w') as f:
        json.dump(experimental_general_sems, f)
    with open('star-3-qsft-qa-experimental-GPT4-RATED-specific_sems.json', 'w') as f:
        json.dump(experimental_specific_sems, f)
    with open('star-3-qsft-qa-experimental-GPT4-RATED-general_topk_sems.json', 'w') as f:
        json.dump(experimental_topk_general_sems, f)
    with open('star-3-qsft-qa-experimental-GPT4-RATED-specific_topk_sems.json', 'w') as f:
    ...
    plt.savefig(f'{FIGURES_PATH}/{VERSION_3_QSFT}/{VERSION_3_QSFT}-log_probs_gpt-4-general-vs-specific-{args.split.name}_top-{args.k}.png')
