...
#SBATCH --output=script-logs-2-mistral-ablation/get-m0-ratings-randomized.out
#SBATCH --error=script-logs-2-mistral-ablation/get-m0-ratings-randomized.err
...
cd ~/research_projects/assistant-gate/experiments/star-2-mistral-ablation/m0-response-win-rates-randomized/
