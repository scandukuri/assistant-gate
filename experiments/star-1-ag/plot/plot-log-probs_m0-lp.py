...
# Show the plot
    if not os.path.exists(f'{FIGURES_PATH}/{VERSION_AG}'):
        os.makedirs(f'{FIGURES_PATH}/{VERSION_AG}')
    plt.savefig(f'{FIGURES_PATH}/{VERSION_AG}/m0_log_probs_{args.split.name}_top-{args.k}.png')
