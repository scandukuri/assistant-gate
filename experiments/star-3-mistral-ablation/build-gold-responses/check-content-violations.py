...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_3_MISTRAL_ABLATION}"):
        os.makedirs(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_3_MISTRAL_ABLATION}")
    with open(f"{CONTENT_VIOLATIONS_PATH}/{VERSION_3_MISTRAL_ABLATION}/{args.split.name}.json", 'w') as f:
