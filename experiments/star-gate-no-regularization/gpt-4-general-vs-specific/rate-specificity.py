...
def main(args: DictConfig) -> None:
    ...
    if not os.path.exists(f"{SPECIFICITY_PATH}/{VERSION_3_QSFT}"):
        os.makedirs(f"{SPECIFICITY_PATH}/{VERSION_3_QSFT}")
    with open(f"{SPECIFICITY_PATH}/{VERSION_3_QSFT}/{args.split.name}_ratings.json", 'w') as f:
